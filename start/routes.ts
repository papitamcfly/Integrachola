...
Route.post('getAllDataDate', 'SensoresController.getAllDataDate')
Route.post('getSingleDataDate', 'SensoresController.getSingleDataDate')
Route.post('getDataByCuna', 'SensoresController.getDataByCuna')
